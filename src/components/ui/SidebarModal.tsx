        ...
        <DialogPrimitive.Content className="fixed left-[50%] top-[50%] z-50 max-h-[90vh] w-[90vw] max-w-5xl translate-x-[-50%] translate-y-[-50%] rounded-2xl bg-background p-0 shadow-2xl duration-200 data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 data-[state=closed]:slide-out-to-left-1/2 data-[state=closed]:slide-out-to-top-[48%] data-[state=open]:slide-in-from-left-1/2 data-[state=open]:slide-in-from-top-[48%] overflow-hidden border border-border">
          <div className="relative h-full max-h-[90vh] overflow-hidden">
            ...
            <div className="flex h-[90vh]">
              {/* Sidebar */}
              <div
                className={`${sidebarWidth} bg-secondary/30 border-r border-border p-4`}
              >
                ...
                <nav className="space-y-1">
                  {sidebarItems.map((item) => {
                    ...
                    return (
                      ...
                      >
                        <Icon
                          className={`h-4 w-4 flex-shrink-0 ${activeSection === item.id ? "text-primary" : ""
                            }`}
                        />
