  ...
  const renderCurrentPrompts = () => (
    <div className="space-y-6">
      ...
      <Card>
        ...
        <CardContent>
          <div className="bg-secondary/50 border border-border rounded-lg p-4 font-mono text-sm text-foreground">
          ...
          <CardContent className="p-6 space-y-4">
            <div className="grid grid-cols-2 gap-4 text-sm">
              <div>
                ...
                <span className="ml-2 font-medium text-foreground">{reasoningModel}</span>
              </div>
              <div>
                <span className="text-muted-foreground">Provider:</span>
                <span className="ml-2 font-medium capitalize text-foreground">{providerLabel}</span>
            ...
            <div>
              <label className="block text-sm font-medium mb-2 text-foreground">Test Input</label>
              <Textarea
                value={testText}
